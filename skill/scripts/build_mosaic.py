...
DEFAULT_BASE       = os.environ.get("MSTR_BASE", "https://<tenant>.strategy.com/MicroStrategyLibrary")
...
def friendly_table(tname: str) -> str:
    ...
    # Strip leading prefixes like SD_TECH_EXAMPLE_20260413_2145_  or similar
