# Kobo subscription & promotion extension — 2026-08-19

Extends the Studio Mosaic model **"Kobo Content & Customer Engagement Model"**
(`20B2F4E3B58A47C7825C2C7A8D0559E9`, Shared Studio > My Reports > Kobo,
...
Kobo (Rakuten) wants one trusted view across **digital book sales,
...
| --- | --- | --- |
| `KOBO_SUBSCRIPTION_MONTHS` | subscriber × calendar month (periodic snapshot; `DATE` = first of month) | **Subscription Revenue** = SUM(MRR_AMOUNT), **Active Subscribers** = SUM(IS_ACTIVE_EOM) |
| `KOBO_PROMO_REDEMPTIONS` | promo redemption (≤1 per SALES transaction, `TRANSACTION_ID` unique) | **Promo Discount Amount** = SUM(DISCOUNT_AMOUNT) |
...
2025-01..2026-08, Kobo Plus tiers 7.99/7.99/9.99) and **1,239** promo
redemptions (34% of the 3,600 transactions, 10 campaigns incl. Black Friday
2025, Rakuten Super Points Day, format/category-targeted windows).
