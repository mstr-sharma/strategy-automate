...
- **destination folder**: `DC377018BD4CACD81B7E4CAEB8DB62B4` (Shared Reports/Collaboration/Arpan Sharma)
...
| TENANTS (WACSE/WACSE) | `854074F02BEA4AF580B7B217C4791D1D` | 10 |
| USAGE_HOURLY (WACSE/WACSE) | `FC75A50067A04CB58377121B1CF4AF46` | ~126k |
...
## Security
- **SF**: `A5F38FC12A104642A0A21849A2DE79D4` — name "Tenant = NovaForge AI" (shape B element_list, `hNovaForge AI`)
- **Assigned user**: Tommy OConnell — `DBE00854E14B8D8919D3FBADCA61894B`, abbreviation `toconnell` (HTTP 204 from `PATCH /api/dataModels/{id}/securityFilters/{sf}/members`)
...
6. **SF create failed with `attribute_form_custom` (`8004c767`)** — Mosaic rejected the DESC form binding. Fixed with Shape B `predicate_element_list` using `hNovaForge AI`.
...
- Post-wait rels + SF/Tommy + cleanse: ~6 min
