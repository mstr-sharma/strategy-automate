...
<snowflake-schema> + 2 Neon PG), Shared Studio > My Reports > EReaderCo:

- **Rebuilt (main)**: "EReaderCo Content & Customer Engagement Model"
...
- **Copy**: "Built-by-Claude_EReaderCo Content & Customer Engagement Model"
...
| **Active Subscribers** | **missing** — AI demoted the 0/1 flag to attribute "Is Active End Of Month", deleting the governed ARPU denominator | **recreated**: SUM(EREADER_SUBSCRIPTION_MONTHS.IS_ACTIVE_EOM), integer | 3rd requested metric; attribute left in place for filtering |
...
EREADER_SUBSCRIPTION_MONTHS + EREADER_PROMO_REDEMPTIONS.
...
1. **One conformed date**: `EREADER_SUBSCRIPTION_MONTHS.DATE` mapped into the shared
