...
| `8004cc63` | "Attribute does not contain a form with the ID" on PATCH | Post-build form-category PATCH is fragile. Fix form names at CREATE time. | `feedback_mosaic_ship_bar.md` |
...
| `8004cf06` | "attribute has no report display" at commit | Step 4 of the clone-and-remap PATCH was missed — `displays.reportDisplays` not set. | `reference_strategy_object_cloning.md` |
