...
---
**Mosaic MCP (connected):** prefix `mcp__df3a3274-2371-452c-ac93-7d58f2af669f__` — read-only over an *already-published* Mosaic model.
...
**Strategy REST:** no first-class MCP; invoked directly by `~/.claude/skills/build-mosaic-model/scripts/build_mosaic.py` using credentials from memory.
