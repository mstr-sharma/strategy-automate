...
How to apply:
- Use direct REST via `skill/scripts/build_mosaic.py` for scratch Mosaic model creation because tenant behavior can differ from public wrappers and the helper already encodes <tenant>.strategy.com quirks.
