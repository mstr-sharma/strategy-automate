...
**Observed 2026-04-23.** After ~10–15 `build_mosaic.py` invocations against `<tenant>.strategy.com` (`build`, `api-call`, `delete-model`, `publish`, `add-security-filter`, etc.), subsequent calls returned:
