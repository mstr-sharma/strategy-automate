...
**Observed 2026-04-23 on a Strategy ONE Cloud tenant (<tenant>.strategy.com).** After ~10–15 `build_mosaic.py` invocations (`build`, `api-call`, `delete-model`, `publish`, `add-security-filter`, etc.), subsequent calls returned:
